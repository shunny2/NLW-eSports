...
export function CreateAdModal() {
    ...
    async function handleCreatAd(event: FormEvent) {
        ...
        try {
            await axios.post(`http://localhost:3000/games/${gamesInput}/ads`, {
                "name": data.name,
                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <Select.Root onValueChange={setGamesInput}>
                                <Select.SelectTrigger
                                    ...
                                    name="game"
                                    aria-label="Game"
                                    className={`bg-zinc-900 py-3 px-4 rounded text-small flex justify-between ${gamesInput ? "text-white" : "text-zinc-500"
                                        }`}
                                ...
                                <Select.SelectPortal>
                                    <Select.SelectContent className="bg-zinc-900 rounded overflow-hidden">
                                        ...
                                        <Select.ScrollDownButton className='bg-zinc-900 flex items-center justify-center cursor-default'>
                                            <CaretDown size={24} />
